...
## H2. _Home_ de usuarios administradores 
### Descripción
Como usuario logueado con el _rol_ ADMINISTRADOR se tendrá acceso a al _home_ de administradores, desde el cual
se podrá acceder a las funcionalidades de _Gestión de Usuarios_ y _Gestión de Tipos de IVA_. También se tendrá una acción _Desconectar_ con la que cerrar la sesión.
...
## H4. Creación/edición de datos de un _Usuario_ 
### Descripción
...
## H6. Creación/edición de datos de un _Tipo de IVA_ 
### Descripción
...
## H7. Gestión de _Formas de Pago_ 
### Descripción
Como usuario logueado con el _rol_ USUARIO, desde la opción _Formas de Pago_ se tendrá acceso a la lista de _Formas de Pago_ propias del usuario. Seleccionando una de esas _Formas de Pago_ ésta se podrá eliminar lógicamente o acceder a la opción de editar sus datos. También será posible seleccionar la creación de una nueva _Forma de Pago_ vinculada al usuario actual.

**NOTA:** Las _Formas de Pago_ son específicas de cada usuario y no son entidades globales del sistema. Cada usuario gestiona sus propias formas de pago.

### Criterios de aceptación
* Se mostrará una lista con las _Formas de Pago_ del usuario actual, indicando sus datos (descripción, número de pagos, periodicidad, estado [activa/inactiva])
* Se podrá filtrar la lista mostrando solo las _Formas de Pago_ activas mediante un parámetro `soloActivas`
* Se podrá seleccionar una _Forma de Pago_ de esa lista y mediante un botón _Editar_ acceder a la edición de la _Forma de Pago_ seleccionada. Una vez completada esa edición se actualizará la lista de _Formas de Pago_ del usuario.
* Se podrá seleccionar una _Forma de Pago_ de esa lista y mediante un botón _Borrar_ realizar la eliminación lógica de esa _Forma de Pago_, estableciento su estado a _inactiva_. Una vez completada esa edición se actualizará la lista de _Formas de Pago_.
* Mediante un botón _Nueva_ se accederá a la definción de una nueva _Forma de Pago_ vinculada al usuario actual.
* Solo se puede acceder a las _Formas de Pago_ propias (seguridad basada en recursos)
...
## H8. Creación/edición de datos de una _Forma de Pago_ 
### Descripción
Como usuario logueado con el _rol_ USUARIO, desde la vista de creación/edición de _Formas de Pago_ se podrán editar los datos esenciales de una forma de pago propia, guardándolos una vez completada la creación/edición.

Datos a editar:
* descripción ('contado', 'transferencia', 'transferencia a 30 días', 'transferencias a 30-60-90 días', etc.)
...
* La _Forma de Pago_ queda automáticamente vinculada al usuario actual 
...
* Solo se puede editar una _Forma de Pago_ propia (seguridad basada en recursos)
* Al pulsar el botón _Cancelar_ se retornará a la vista anterior, desechando los cambios pendientes de actualizar.
...
## H9. _Home_ de usuarios  
### Descripción
Como usuario logueado con el _rol_ USUARIO se tendrá acceso a al _home_ de usuario, desde el cual
se podrá acceder a las funcionalidades de _Perfil_, _Datos de Facturación_, _Gestión de Formas de Pago_, _Gestión de Clientes_, _Gestión de Facturas_, _Gestión de Vencimientos/Pagos_. También se tendrá una acción _Desconectar_ con la que cerrar la sesión.
...
## H10. Edición del _Perfil de Usuario_  
### Descripción
...
## H11. Edición de los _Datos de Facturación_  
### Descripción
...
* Se mostrará a los usuarios sus _Datos de Facturación_, dando opción a editarlos
  ...
  * tipo de IVA por defecto (seleccionado de la lista global de tipos de IVA)
  * forma de pago por defecto (seleccionado de las formas de pago propias del usuario)
...
* La _forma de pago por defecto_ solo puede ser una de las formas de pago del propio usuario
...
* Solo se puede acceder a los _Clientes_ propios (seguridad basada en recursos)
...
## H13. Creación/edición de datos de un _Cliente_ 
### Descripción
...
* El _Cliente_ queda automáticamente vinculado al usuario actual 
...
* Solo se puede editar un _Cliente_ propio (seguridad basada en recursos)
* En caso de que los datos introducidos presenten algún error o existan datos requeridos no introducidos, se informará del error, dando opción a introducirlos correctamente
* Al pulsar el botón _Cancelar_ se retornará a la vista anterior, desechando los cambios pendientes de actualizar.
...
## H15. Creación/edición de datos de una _Factura_
### Descripción
...
* ejercicio
* cliente (seleccionado de la lista de clientes propios del usuario)
* fecha de emisión (editable)
* forma de pago (inicializado con la forma de pago por defecto del usuario actual, seleccionable de la lista de formas de pago propias del usuario)
...
* tipo de IVA (inicializado con el tipo de IVA por defecto del usuario actual, seleccionable de la lista global de tipos de IVA)
* importe total (calculado, no editable)


### Criterios de aceptación
* Se mostrarán los datos de la _Factura_ selecionada (o campos vacíos en el caso de la creación de una nueva)
* La _Factura_ queda automáticamente vinculada al usuario actual 
* El _cliente_ seleccionado debe pertenecer al usuario actual
* La _forma de pago_ seleccionada debe pertenecer al usuario actual
* Se mostrará la lista de _Líneas de Factura_ que componen la _Factura_ actual, permitiendo
  * añadir una nueva _Línea de Factura_ con los datos aportados
...
* Solo se puede editar una _Factura_ propia (seguridad basada en recursos)
* En caso de que los datos introducidos presenten algún error o existan datos requeridos no introducidos, se informará del error, dando opción a introducirlos correctamente
* Al pulsar el botón _Cancelar_ se retornará a la vista anterior, desechando los cambios pendientes de actualizar.
...
## H16. Gestión de _Pagos_
### Descripción
Como usuario logueado con el _rol_ USUARIO, desde la opción _Pagos_ se tendrá acceso a la lista de _Pagos_ previstos para el usuario actual. Seleccionando uno de estos _Pagos_, se podrá cambiar su estado.
...
* Se podrá seleccionar un _Pago_ de esa lista y modificar su estado (pendiente, pagado, anulado)
* Solo se puede acceder a los _Pagos_ propios (seguridad basada en recursos, verificada a través de la factura)
...
## H17. Seguridad Basada en Recursos
### Descripción
Como usuario logueado con el _rol_ USUARIO, el sistema debe garantizar que solo puedo acceder, crear, modificar o eliminar mis propios recursos (Clientes, Facturas, Formas de Pago, Pagos). Los usuarios con _rol_ ADMINISTRADOR pueden acceder a todos los recursos.

**NOTA:** Esta seguridad se implementa a nivel de Spring Security usando `@PreAuthorize` con expresiones SpEL que verifican la propiedad de los recursos.

### Criterios de aceptación
* Un usuario con _rol_ USUARIO **solo puede acceder** a sus propios:
  * Clientes
  * Facturas
  * Formas de Pago
  * Pagos (verificados a través de la factura asociada)
* Si un usuario intenta acceder a un recurso que no le pertenece, recibirá un error **403 Forbidden**
* Un usuario con _rol_ ADMINISTRADOR puede acceder a **todos los recursos** de todos los usuarios (bypass de restricciones)
* La verificación de propiedad se realiza automáticamente antes de ejecutar cualquier operación CRUD
* La implementación usa `@PreAuthorize` con expresiones SpEL que invocan métodos del componente `ResourceSecurityService`
* Los métodos de verificación incluyen:
  * `canAccess(Long usuarioId)` - Verifica si el usuarioId corresponde al usuario autenticado o es admin
  ...
  * `canAccessPago(Long pagoId)` - Verifica propiedad de pago (a través de factura)
...
**Documentación adicional:** Ver archivo `SEGURIDAD_RECURSOS.md` para detalles completos de implementación.
